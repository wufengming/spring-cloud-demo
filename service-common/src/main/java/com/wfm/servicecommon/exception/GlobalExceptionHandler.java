...
public class GlobalExceptionHandler {
    ...
    public ApiResult handleMethodArgumentNotValidExceptionHandler(MethodArgumentNotValidException ex) throws JsonProcessingException {
        ...
        log.error("fieldErrors" + mapper.writeValueAsString(list));
    ...
    public ApiResult sysLoginExceptionHandler(LoginException exception) {
    ...
    @ResponseStatus(HttpStatus.OK)
    public ApiResult springBootPlusExceptionHandler(SpringBootException exception) {
